...
@app.post("/solve/{algo_id}")
async def solve(algo_id: str, request: AlgorithmRequest):
    try:
        # Add the current api/ directory to sys.path so Vercel can find algorithms during execution
        sys.path.append(os.path.dirname(os.path.abspath(__file__)))
        ...
        # Map of algo_id to their respective runner and tracker
        algos = {
        ...
        # Simple dynamic call based on standardized signatures
        ...
        # RETURN THE EXACT TRACEBACK IN JSON!
